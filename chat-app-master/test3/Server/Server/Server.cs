        ...
        private void SendTextBox_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (sendTextBox.Text.Length > 0)
                {
                    ...
                    RSACryptoServiceProvider read = new RSACryptoServiceProvider();
                    read.FromXmlString(publicKey);
...
public class RsaEncrypttion
{
    ...
    public string Encrypt(string plainText,string key)
    {
        ...
        _publicKey = csp.FromXmlString(key);
    ...
    public string Decrypt(string cypherText, string publicKey)
    {
